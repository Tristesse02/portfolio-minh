...
import { Play, Pause, ArrowLeft, Heart, MessageCircle, Share } from "lucide-react"
...
const articleData: Record<string, ArticleContent> = {
  "about-me": {
    ...
    title: "About me",
    category: "about",
    description: "Passionate full-stack developer with a love for creating innovative solutions.",
    fullContent: {
      introduction:
      ...
      technologies: ["JavaScript", "TypeScript", "React", "Node.js", "Python", "AWS"],
    },
  ...
  meta: {
    ...
    category: "experience",
    description: "Worked on React Native components for Instagram, improving user engagement by 15%.",
    fullContent: {
      introduction:
      ...
      technologies: ["React Native", "JavaScript", "iOS", "Android", "GraphQL", "Relay"],
    },
    audioUrl: "/placeholder-audio.mp3",
    imageUrl: "/placeholder.svg?height=400&width=600",
    likes: 312,
...
export default function ArticlePage({ params }: { params: { id: string } }) {
  ...
  const [isPlaying, setIsPlaying] = useState(searchParams.get("playing") === "true")
  const [currentTime, setCurrentTime] = useState(Number.parseInt(searchParams.get("time") || "0"))
    ...
    <div className="min-h-screen bg-white pb-24">
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        ...
        <article className="prose prose-lg max-w-none">
          <p className="text-lg text-gray-700 leading-relaxed mb-8">{article.fullContent.introduction}</p>
            ...
            <div className="mb-8">
              ...
              <div className="flex gap-4">
                {article.fullContent.links.github && (
                  <Button asChild>
                    <a href={article.fullContent.links.github} target="_blank" rel="noopener noreferrer">
                      View on GitHub
                    </a>
                  </Button>
                )}
                {article.fullContent.links.demo && (
                  <Button variant="outline" asChild>
                    <a href={article.fullContent.links.demo} target="_blank" rel="noopener noreferrer">
                      Live Demo
                    </a>
                  </Button>
                )}
          ...
          <div className="border-t border-gray-200 pt-8">
            <p className="text-lg text-gray-700 leading-relaxed">{article.fullContent.conclusion}</p>
          </div>
        </article>
